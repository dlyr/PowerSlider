...
PowerSliderPlugin::PowerSliderPlugin(QObject *parent)
	: QObject(parent)
{
	initialized = false;
}
...
void PowerSliderPlugin::initialize(QDesignerFormEditorInterface * /*core*/)
{
	if (initialized)
        ...
        Q_ASSERT(core != 0);
        core->registerExtensions(new QExtensionFactory(core), 
...
bool PowerSliderPlugin::isInitialized() const
{
	return initialized;
}
...
QString PowerSliderPlugin::name() const
{
	return QLatin1String("PowerSlider");
}
...
QString PowerSliderPlugin::toolTip() const
{
	return QString();
}

QString PowerSliderPlugin::whatsThis() const
{
	return QString();
}

bool PowerSliderPlugin::isContainer() const
{
	return false;
}
...
{
	return QLatin1String("PowerSlider.h");
}

QString PowerSliderPlugin::codeTemplate() const
{
	return QString();
}
...
/*
PowerSliderPropertySheetFactory::PowerSliderPropertySheetFactory
...
QObject *PowerSliderPropertySheetFactory::createExtension(QObject *object,
                                                    const QString &iid,
                                                    QObject *parent) const
 {
     ...
     if (PowerSlider *ps = qobject_cast<PowerSlider*>(object))
         return new PowerSliderPropertySheet(ps, parent);
     
     return 0;
 }
*/
Q_EXPORT_PLUGIN(PowerSliderPlugin)
